...
InitLists()
{
	...
	float earRadius = 0.35f;
	float faceRadius = 0.4f;

	MickeyList = glGenLists(1);
	glNewList(MickeyList, GL_COMPILE);

	// Head
	glColor3f(0.f, 0.f, 0.f); // Black
	glPushMatrix();
	glTranslatef(0.f, 0.f, 0.f);
	OsuSphere(headRadius, 50, 50);
	glPopMatrix();

	// Ears
	glColor3f(0.f, 0.f, 0.f); // Black
	glPushMatrix();
	glTranslatef(headRadius * 0.7f, headRadius * 0.7f, 0.f);
	OsuSphere(earRadius, 50, 50);
	glPopMatrix();
	...
	//Face
	glColor3f(1.f, 0.843f, 0.f); // Gold or skin-like color
	glPushMatrix();
	glTranslatef(0.f, -0.1f, headRadius * 0.8f);
	OsuSphere(faceRadius, 50, 50);
	glPopMatrix();
